...
/// @endcode
		...
		public:
				...
				writerIndex_(kCheapPrepend) 
			{
				...
				assert(initialSize == writableBytes());
			...
			const  char* findCRLF() const {
				...
				return beginWrite() == crlf ? nullptr : crlf;
			}
			...
			/// 
			/// Required: buf->readableBytes() >= sizeof(int64_t)
			...
			/// 
			/// Required:buf->readableBytes() >= sizeof(int32_t)
			...
			/// 
			/// Require: buf->readableBytes() >= sizefo(int32_t)
			int32_t readInt32() {
